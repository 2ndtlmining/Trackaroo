...
- `web/` — Phase 3 frontend (SvelteKit + TS + Tailwind v4 + adapter-node):
  ...
  - `test/` — vitest: formats (32), change (11), filters (18), theme (7), repos (55), components (44), listingsPanel (10), compareRows (6), tableSort (5) — **188 tests**
...
- **Frontend:** `svelte-check` 0 errors; vitest **188 passing**; Playwright e2e **46 passing**; production build green; live `adapter-node` smoke test of all routes against the real DB (dashboard/products/movers/product 200s, unknown product 404, bad window param falls back)
...
- **Regression:** backend 391 passing (pytest); frontend 188 passing (vitest) + 46 e2e (Playwright)
