...
| **Frontend tests** | ✅ Complete | 171 vitest + 42 Playwright e2e (with a `goto()` hydration helper) |
...
# Run frontend unit tests (171 vitest)
npm test
...
└── web/                # Phase 3 frontend (SvelteKit, adapter-node)
    ...
    ├── test/                   # 171 vitest regression tests (8 suites)
